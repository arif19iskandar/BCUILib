...
public class BCRelativeTimeString {
    public static final String NOW = "Baru saja";
    public static final String IN_FEW_SECONDS = "Dalam beberapa detik";
    public static final String AGO = "yang lalu";
    public static final String IN = "Dalam";
    ...
    public static final String IN_ONE_DAY = "Besok";
